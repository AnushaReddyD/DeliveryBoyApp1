...
<html>
    <head>
        ...
        <style type="text/css">
            ...
            filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#ffaf4b', endColorsr='#ff920a', GradientType=0 );
            	}	
  ...
  <body>
      <div class="cont-fluid">
        ...
        <?php 
            $sql="select * from tbl_cod_dtl where order_status=2";
