				...
				<div class="column">
					...
					<div id="dl-menu" class="dl-menuwrapper">
						...
						<ul class="dl-menu">
                            ...
                            <li><a href="trynowintransitorders.php">Intransit Orders</a></li>

							<li><a href="trynowdeliveredorder.php">Delivered Orders</a></li>
...
<?php 
		 ...
		 $trynow_id=$_POST['trynow_id'];

		 $status=$_POST['status'];

		 $sql="update tbl_trynow set order_status=$status,accepted_status=1 where trynow_id=$trynow_id";
...
$sql="select * from tbl_trynow where order_status=1";
...
<table>
 ...
 <td width="30%"><?php echo date('j - M',strtotime($rec['created_date'])); ?></td>
    ...
    <tr class="tr-border">
      ...
      <td class="table-label products-line" colspan="2"><?php echo $rec_user['address']; ?>.</td>
...
<td class="table-label">Total Rs. <?php echo $rec_products['mrp']; ?></td>
    ...
    <td class="table-input"><select name="status">
    ...
    <option <?php if($rec['order_status']==2){ echo 'selected="selected"';} ?> value="2">Delivered</option>
     ...
     <input type="hidden" name="trynow_id" value="<?php echo $rec['trynow_id']; ?>" />
...
<td class="table-input" style="float:right;"><input style="    background: #0C67D1;
    ...
    width: 76%;" type="submit"  name="submit" value="Submit" /></td>
...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js"></script>
	...
	<script>
       ...
       $("#list1").load("trynowintransitorders.php");
