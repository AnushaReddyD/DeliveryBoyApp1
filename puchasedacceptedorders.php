...
<head>
    ...
    <style type="text/css">
            ...
            .table-input{ width:68%; height:auto; float:left; line-height:20px; font-weight:600 !important; text-align:left;     color: #474747; text-indent:5px;
                font-size: 15px;}
            ...
            .proj-link img{ width:100%; height:90px; }
...
<?php 
    $sql="select * from tbl_paymenthistory where accepted_status=1 order by payment_id desc";
...
<table>
    <tr class="tr-border">
        ...
        <a href="#" class="proj-link"><img src="http://twstesting.com/snapper/logos/<?php echo $rec_vendor['vendor_logo']; ?>" /></a>
        <p style="margin:-2px;padding:0;">&nbsp;<img src="http://twstesting.com/deliveryapp/images/mapmarker2.gif"/ width="16" height="16">&nbsp;<span>Madhapoor</span></p>
        <?php ?></div>
        </td>
        <td class="table-input">    
       	<table>
        	<tr class="cust-name">
            	<td colspan="2" width="80%"><strong><?php echo $rec_user['fullname']; ?> <?php echo $rec_user['mobile']; ?></strong></td>
                <td width="20%"><span style="font-size:10px ;font-weight:700;"> <?php echo date('j - M',strtotime($rec['created_date'])); ?></span></td>
            </tr>
            <tr class="cust-odd">
            	<td colspan="3"><span><?php echo $rec['address']; ?></span></td>
            </tr>
            ...
            <tr class="prod-name">
                <td colspan="3">
                <strong style="color:#D03399;">Total Rs.<?php echo $rec['amount']; ?></strong>
                </td>
            </tr>
      </table>
        <tr>
            <td class="button-submit"><!--<input type="button" value="Cancel" />-->
            <a href="updatepurchasedorder.php?id=<?php echo $rec['payment_id']; ?>" value="">UPDATE</a></td> 
        </tr>
    </td>
</tr>
</table>
