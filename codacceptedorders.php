...
<html>
    <head>
        ...
        <style type="text/css">
            ...
            .proj-link img{ width:100%; height:100px; }
    ...
    <body>
      <div class="cont-fluid"><!-- cont-fluid starts -->
         <div class="content-head"><!-- content-head starts -->
            <div class="logo"><a href="home.php"><img src="images/logo.png"/></a></div>	
                <div class="back"><!-- back starts-->
                    <div class="container demo-2"><!-- container demo-2 starts -->				
            			<div class="main clearfix">	<!-- main clearfix starts -->			
            				<div class="column"><!-- /dl-menuwrapper ends-->
            					<div id="dl-menu" class="dl-menuwrapper"><!-- /dl-menuwrapper -->
            					...
            					</div><!-- /dl-menuwrapper ends-->
            				</div><!-- main clearfix ends -->
            			</div><!-- container demo-2 ends -->   
            		</div><!-- back ends-->
                </div><!-- content-head ends -->
        </div><!-- cont-fluid ends -->
    <div class="clear">
        <div class="main-buttons">
            <div class="assign-task">
                <?php 
                    $sql="select * from tbl_cod_dtl where accepted_status=1";
                ...
                <table>
                    <tr class="tr-border">
                        ...
                        <td class="table-input">
                       	...
                       	<table>
                            ...
                            <tr class="prod-name" style="text-indent: 0px !important;">
                            	<td colspan="3"><strong>Products:</strong>
                        ...
                        <tr>     
                            ...
                            <a href="updatecodorder.php?id=<?php echo $rec['cod_id']; ?>" value="">UPDATE</a></td> 
                        </tr>
                       </td>
                    </tr>
                </table>
