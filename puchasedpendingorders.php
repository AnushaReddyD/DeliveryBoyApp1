                ...
                <div class="back">
                    <div class="container demo-2">				
						...
						<ul class="dl-menu">                      
                            ...
                            <li><a href="puchasedintransitorders.php">Accepted Orders</a></li>
...
<?php 
    $sql="select * from tbl_paymenthistory where order_status=0";
...
<table>
    <tr class="tr-border">
        ...
        <td class="table-input">    
       	<table>
        	<tr class="cust-name">
            	<td colspan="2" width="60%"><strong><?php echo $rec_user['fullname']; ?></strong></td>
                <td width="40%"><?php echo date('j - M H:i',strtotime($rec['created_date'])); ?></td>
            </tr>
            <tr class="cust-odd">
        ...
        <tr>      
           ...
           <a href="updatepurchasedorder.php?id=<?php echo $rec['payment_id']; ?>" value="">ACCEPT</a></td> 
        </tr>       
       </td>
    </tr>
</table>
