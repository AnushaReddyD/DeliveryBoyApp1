				...
				<div class="column">
					<div id="dl-menu" class="dl-menuwrapper">
						...
						<ul class="dl-menu">                     
                            ...
                            <li><a href="trynowacceptedorders.php">Accepted Orders</a></li>
...
<?php 
    $sql="select * from tbl_trynow where accepted_status=1";
...
<p style="margin:0;padding:0;">&nbsp;<img src="http://twstesting.com/deliveryapp/images/mapmarker2.gif"/ width="16" height="16">&nbsp;<span><?php echo $rec_storeloc['location_title']; ?></span></p>
       ...
       <td class="table-input">
       	...
       	<table>
        	<tr class="cust-name">
            	<td colspan="2" width="60%"><strong><?php echo $rec_user['fullname']; ?> <?php echo $rec_user['mobile']; ?></strong></td>
       ...
       <a href="updatetrynoworder.php?id=<?php echo $rec['trynow_id']; ?>" value="">UPDATE</a></td> 
    </tr>
